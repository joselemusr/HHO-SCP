...
def GWOQL_SCP(id,instance_file,instance_dir,population,maxIter,discretizacionScheme,ql_alpha,ql_gamma):
    ...
    matrixBin,fitness,solutionsRank  = Problem.SCP(solutions,matrixBin,solutionsRank,vectorCostos,matrizCobertura,DS_actions[DS])
